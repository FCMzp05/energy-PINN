...
function parse_cli!(cfg::Config)
    ...
    if isempty(cfg.output_dir)
        cfg.output_dir = joinpath(@__DIR__, "outputs", "bimaterial_shear_fem")
    end
    return cfg
end
...
function main()
    ...
    save_fields_csv(joinpath(cfg.output_dir, "bimaterial_shear_fem_fields.csv"), mesh.nodes, fields)
    save_quads_csv(joinpath(cfg.output_dir, "bimaterial_shear_fem_mesh.csv"), mesh.quads; material_ids = material_ids)
    save_boundary_csv(joinpath(cfg.output_dir, "bimaterial_shear_fem_boundary_left.csv"), left_nodes)
    save_boundary_csv(joinpath(cfg.output_dir, "bimaterial_shear_fem_boundary_right.csv"), right_nodes)
    save_boundary_csv(joinpath(cfg.output_dir, "bimaterial_shear_fem_boundary_bottom.csv"), bottom_nodes)
    save_edges_csv(joinpath(cfg.output_dir, "bimaterial_shear_fem_top_edges.csv"), top_edges)
    write_run_config(
        joinpath(cfg.output_dir, "bimaterial_shear_fem_run_config.txt"),
        [
            "width" => cfg.width,
            "height" => cfg.height,
